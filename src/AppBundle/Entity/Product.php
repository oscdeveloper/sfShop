...
class Product
{
     ...
     * 
     * @Assert\NotNull()
     * @Assert\Range(min=0.01,minMessage="Cena musi być większa lub równa {{ limit }}")
     */
    private $price = 0;
    ...
    */
     ...
     * @return Product
     */
    public function addOrder(\AppBundle\Entity\ProductOrder $orders)
    {
        $this->orders[] = $orders;
     ...
     * @param \AppBundle\Entity\ProductOrder $orders
     */
    public function removeOrder(\AppBundle\Entity\ProductOrder $orders)
    {
